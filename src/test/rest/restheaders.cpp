...
TEST_CASE("RestHeaders", "[headers]") {
    SECTION("Write succeeds") {
    ...
    SECTION("Read returns EOH, but no Content-Length") {
        class MockProtocol : public Protocol {
        public:
            virtual bool read(std::vector<char> & data, bool allowPartialRead, Host & hostState) {
                const std::string testString = "This is a test\r\nSecond line\r\n\r\n";
    ...
    SECTION("Read returns EOH, Content-Length == 0") {
        class MockProtocol : public Protocol {
        public:
            virtual bool read(std::vector<char> & data, bool allowPartialRead, Host & hostState) {
                const std::string testString = "This is a test\r\nSecond line\r\nContent-Length: 0\r\n\r\n";
    ...
    SECTION("Read returns EOH, Content-Length == -1") {
        class MockProtocol : public Protocol {
        public:
            virtual bool read(std::vector<char> & data, bool allowPartialRead, Host & hostState) {
                const std::string testString = "This is a test\r\nSecond line\r\nContent-Length: -1\r\n\r\n";
    ...
    SECTION("Read returns EOH, Content-Length == invalid") {
        class MockProtocol : public Protocol {
        public:
            virtual bool read(std::vector<char> & data, bool allowPartialRead, Host & hostState) {
    ...
    SECTION("Read returns EOH, valid Content-Length, but no content") {
        class MockProtocol : public Protocol {
        public:
            MockProtocol() : counter(0) {
            }
    ...
    SECTION("Read returns EOH, valid Content-Length and valid content in one read") {
        ...
        MockProtocol mockProtocol(baseData, testData);
        RestHeaders headers;
        Host host = Host::ALL_INTERFACES4;
        std::vector<char> data;
        REQUIRE(headers.read(mockProtocol, data, host));
    ...
    SECTION("Read returns EOH, valid Content-Length and valid content in two reads") {
        const std::string baseData = "This is a test\r\nSecond line\r\nContent-Length: ";
        const std::string testData = "0123456789testData";
        const std::string expectedData = baseData + std::to_string(testData.length()) +
            "\r\n\r\n" + testData;
    ...
    SECTION("Read returns EOH, valid Content-Length and short content") {
        const std::string baseData = "This is a test\r\nSecond line\r\nContent-Length: ";
        const std::string testData = "0123456789testData";
        const std::string expectedData = baseData + std::to_string(testData.length()) +
        "\r\n\r\n" + testData;
    ...
    SECTION("Read returns EOH, valid Content-Length and too much content") {
        const std::string baseData = "This is a test\r\nSecond line\r\nContent-Length: ";
        const std::string testData = "0123456789testData";
        const std::string expectedData = baseData + std::to_string(testData.length()) +
        "\r\n\r\n" + testData;
